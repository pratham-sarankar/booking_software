            ...
            <div class="container-xl">
                ...
                <div class="row row-deck row-cards">
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('admin.update.blog', ['blog_id' => $blogDetails->blog_id]) }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" class="form-control" name="blog_cover"
                                                        id="cover" accept=".jpeg,.jpg,.png,.webp" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-6 mb-3">
                                                ...
                                                <a target="_blank" id="divCoverImg">
                                                    <img id="coverPreview" src="{{ asset($blogDetails->blog_cover) }}"
                                                        class="card-img-top cover-preview">
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control text-capitalize" name="short_description" id="short_description"
                                                        placeholder="{{ __('Short Description') }}" cols="30" rows="3" required>{{ $blogDetails->short_description }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="long_description" id="long_description" cols="30" rows="5"
                                                        class="form-control text-capitalize" placeholder="{{ __('Description') }}">{{ $blogDetails->long_description }}</textarea>
                                                </div>
                                            </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" placeholder="{{ __('Choose a category') }}"
                                                        ...
                                                        @foreach ($blogsCategories as $blogsCategory)
                                                            <option
                                                                value="{{ $blogsCategory->blog_category_id }}"{{ $blogsCategory->blog_category_id == $blogDetails->blog_category_id ? 'selected' : '' }}>
                                                                {{ __($blogsCategory->blog_category_name) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="tags"
                                                        id="tags" placeholder="{{ __('tag 1, tag 2') }}"
                                                        value="{{ $blogDetails->tags }}" required>
                                                    <small
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="seo_title" id="seo_title" cols="30" rows="1" class="form-control text-capitalize"
                                                        placeholder="{{ __('Title') }}" required>{{ $blogDetails->title }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="seo_description" id="seo_description" cols="30" rows="5" class="form-control"
                                                        placeholder="{{ __('Description') }}" required>{{ $blogDetails->description }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $blogDetails->keywords }}" name="seo_keywords"
    ...
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            if (window.history && window.history.pushState) {
                ...
                window.history.pushState('forward', null, window.location.origin + '/admin/blogs');
            }
        });
    </script>
@endsection
