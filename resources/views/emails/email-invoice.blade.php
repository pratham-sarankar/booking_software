...
<head>
    ...
    <title>{{ __('Purchase Invoice') }} - {{ ENV('APP_NAME') }}</title>
    <style>
        /* Base ------------------------------ */
        body {
            width: 100% !important;
                                    ...
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="{{ route('user.view.invoice', $details['booking_transaction_id']) }}"
                                            ...
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <h3>{{ __('Invoice Number:') }}
                                                            {{ $details['invoice_id'] }}</h3>
                                                    </td>
                                                    <td>
