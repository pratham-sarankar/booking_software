...
@extends('layouts.classic', ['meta_title' => '404' . ' - ' . $page[0]->meta_description])
                    ...
                    <div class="flex flex-col justify-between h-full">
                        <div class="mb-8">
                            ...
                            <h3 class="mb-4 text-3xl font-bold font-heading leading-snug">
                                {{ __('Something is wrong!') }}</h3>
                            <p class="text-lg text-gray-600 font-medium leading-normal md:max-w-md">
                                {{ __('The page you are looking for is not found! Try something else or go back to homepage.') }}
                            </p>
                        </div>
                        <div>
