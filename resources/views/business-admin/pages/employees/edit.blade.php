            ...
            <div class="container-xl">
                ...
                <div class="row row-deck row-cards">
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <form
                            action="{{ route('business-admin.update.employee', ['business_id' => $business_id, 'business_employee_id' => $business_employee->business_employee_id]) }}"
                                            ...
                                            <div class="col-md-6 col-xl-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="business_employee_name"
                                                        ...
                                                        value="{{ $business_employee->business_employee_name }}" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control"
                                                        ...
                                                        value="{{ $business_employee->business_employee_email }}"
                                                        required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control"
                                                        ...
                                                        placeholder="{{ __('Employee Phone Number') }}"
                                                        value="{{ $business_employee->business_employee_phone }}"
                                                        required />
                                                </div>
                                            </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <label class="form-check form-switch">
                                                        <input class="form-check-input" type="checkbox" id="is_login"
                                                            ...
                                                            {{ $business_employee->is_login == 1 ? 'checked' : '' }} />
                                                    </label>
                                                </div>
                                            </div>
...
@section('custom-js')
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            toggleLoginFields(); // Call the function when the page loads to set the initial state
        });
