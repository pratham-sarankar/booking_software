...
<head>
    ...
    <link rel="stylesheet" href="{{ url('assets/css/dataTables.bootstrap5.css') }}">
                ...
                <div class="card-body">
                    <div class="text-center mb-1">
                        <a href="#" class="navbar-brand navbar-brand-autodark"><img
                                src="{{ url('installer/img/logo.png') }}" height="36" alt=""></a>
                        <div class="hr-text hr-text-center mb-0 mt-4 hr-text-spaceless">{{ __('Server Requirements') }}
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <div class="col-12">
                            ...
                            <div class="tabs tabs-full">
                                ...
                                <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}"
                                        ...
                                        <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="app_name"
                                                    id="app_name" value="{{ config('app.name') }}"
                                    ...
                                    <div class="tab" style="display: none;" id="tab3content">
                                        <div class="block">
                                            <input type="radio" name="appSettingsTabs" id="appSettingsTab1"
                                                value="null" checked />
                                            ...
                                            <div class="info">
                                                <div
                                                    ...
                                                    <input type="text" name="broadcast_driver"
                                                        id="broadcast_driver" value="log"
                                                ...
                                                <div
                                                    ...
                                                    <label
                                                        ...
                                                        <sup>
                                                            <a href="https://laravel.com/docs/5.4/cache"
                                                                target="_blank"
                                                                title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                                                <i class="fa fa-info-circle fa-fw"
                                                                    aria-hidden="true"></i>
                                            ...
                                            <div class="info">
                                                <div
                                                    ...
                                                    <label for="redis_hostname">
                                                        ...
                                                        <sup>
                                                            <a href="https://laravel.com/docs/5.4/redis"
                                                                target="_blank"
                                                                title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                                                <i class="fa fa-info-circle fa-fw"
                                                                    aria-hidden="true"></i>
                                            ...
                                            <div class="info">
                                                <div
                                                    ...
                                                    <label for="mail_driver">
                                                        ...
                                                        <sup>
                                                            <a href="https://laravel.com/docs/5.4/mail"
                                                                target="_blank"
                                                                title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                                                <i class="fa fa-info-circle fa-fw"
                                                                    aria-hidden="true"></i>
                            ...
                            <div class="hr-text hr-text-center mb-4 mt-4 hr-text-spaceless">Installation Progress
                            </div>
                        </div>
