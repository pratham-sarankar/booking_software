            ...
            <div class="page-header d-print-none">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <a type="button" href="{{ route('business.businesses.add') }}" class="btn btn-primary">
                                ...
                                <table class="table table-vcenter card-table" id="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-start">{{ __('Business Category') }}</th>
                                            <th class="text-start">{{ __('Email') }}</th>
                                            <th class="text-start">{{ __('Phone') }}</th>
                                            <th class="text-start">{{ __('Tax Number') }}</th>
                                    ...
                                    <tbody>
                                        @foreach ($businesses as $business)
                                            <tr>
                                                ...
                                                <td class="text-start">{{ __($plan_name) }}</td>
                                                <td class="text-start"><a class="fw-normal"
                                                        href="{{ route('business-admin.dashboard.index', $business->business_id) }}">{{ __($business->business_name) }}</a>
                                                </td>
                                                <td class="text-start">{{ __($business->business_category_name) }}</td>
                                                <td class="text-start">{{ $business->business_email }}</td>
                                                <td class="text-start">{{ $business->business_phone }}</td>
                                                <td class="text-start">{{ __($business->tax_number) }}</td>
                                                    ...
                                                    <span class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                                            <a class="dropdown-item"
                                                                href="{{ route('business-admin.dashboard.index', $business->business_id) }}">{{ __('Open') }}</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('business-admin.bookings.index', $business->business_id) }}">{{ __('My Bookings') }}</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('business.edit.business', $business->business_id) }}">{{ __('Edit') }}</a>
                                                            @if ($business->status == 0)
...
@section('custom-js')
    ...
    <script>
        ...
        function getBusiness(parameter) {
            ...
            link.setAttribute("href", "{{ route('business.activation.business') }}?business_id=" + parameter);
        }
        ...
        function deleteBusiness(parameter) {
            ...
            link.setAttribute("href", "{{ route('business.delete.business') }}?business_id=" + parameter);
        }
    </script>
@endsection
@endsection
