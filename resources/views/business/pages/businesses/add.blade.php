            ...
            <div class="container-xl">
                ...
                <div class="row row-deck row-cards">
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('business.save.business') }}" method="post" class="card"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="tomselected form-select" name="business_category_id"
                                            ...
                                            <div class="col-md-6 col-xl-4 ">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" min="10" class="form-control"
                                                        name="business_phone" placeholder="{{ __('Phone') }}" required />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <div class="mb-3">
                                                    <label class="form-label required"
                                                        for="country">{{ __('State/Province') }}</label>
                                                    <select class="tomselected form-select" name="business_state"
                                                        onchange="fetchCities(this.value)" id="state" required>
                                                        <option value="" disabled selected>-- {{ __('Select State/Province') }} --</option>
                                            ...
                                            <div class="col-sm-4 col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="tomselected form-select" name="business_city"
                                                        id="city" required>
                                                    </select>
                                                </div>
                                            </div>
...
@section('custom-js')
    ...
    <script>
        function fetchCities(value) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // Destroy TomSelect instance if exists
        ...
        var elementIds = ['state', 'business_category_name'];
