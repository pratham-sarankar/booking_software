...
class AccountController extends Controller
{
    ...
    public function updateAccount(Request $request)
    {
        ...
        // Validate content 
        if ($validator->fails()) {
            return redirect()->route('admin.index.account')->with('failed', trans('Validation Failed!'))->withErrors($validator)->withInput();
        }
        ...
        if (isset($request->profile_picture)) {
            ...
            return redirect()->route('admin.index.account')->with('success', trans('Profile Image Updated Successfully!'));
        } else {
            ...
            if ($request->email != $registerUserData->email) {
                ...
                if ($alreadyRegister <= 0) {
                    ...
                    return redirect()->route('admin.index.account')->with('success', trans('Profile Email Updated Successfully!'));
                } else {
                    return redirect()->route('admin.edit.account')->with('failed', trans('This email address already registered!'));
                }
            }

            return redirect()->route('admin.index.account')->with('success', trans('Profile Updated Successfully!'));
        }
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        // Validate content 
        if ($validator->fails()) {
            return redirect()->route('admin.change.password')->with('failed', trans('Validation Failed!'))->withErrors($validator)->withInput();
        }
        ...
        if ($request->new_password == $request->confirm_password) {
            ...
            return redirect()->route('admin.index.account')->with('success', trans('Profile Password Changed Successfully!'));
        } else {
