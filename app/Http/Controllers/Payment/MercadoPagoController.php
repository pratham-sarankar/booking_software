...
class MercadoPagoController extends Controller
{
    ...
    public function prepareMercadoPago(Request $request, $planId)
    {
        ...
        if (!$plan_details) {
            return redirect()->route('business.plans.index')->with('failed', trans('Invalid Plan!'));
        }
        ...
        $amountToBePaidMercadoPago = (float)number_format($amountToBePaid, 2) * 100;
        ...
        $payload = [
            'items' => [
                [
                    ...
                    'quantity' => 1,
                    'unit_price' => $amountToBePaidMercadoPago,
        ...
        if ($response->successful()) {
            ...
            // Store the Mercado Pago preference ID
            ...
            $transaction->payment_gateway_name = "MercadoPago";
            ...
            // Handle API error
            return redirect()->route('business.plans.index')->with('failed', trans('Unable to create payment!'));
        }
    }
    ...
    public function success(Request $request)
    {
        ...
        if (!$transaction_details) {
            return redirect()->route('business.plans.index')->with('failed', trans('Transaction not found or already processed!'));
        }
    ...
    public function pending(Request $request)
    {
        ...
        return redirect()->route('business.plans.index')->with('failed', trans("Payment is pending!"));
    }
}
